...
from poker_ai.game import (ACTION_NAMES, ALL_IN, CHECK_CALL, FOLD, HeadsUpHand,
                           RAISE_HALF, RAISE_POT, STREET_NAMES)

HUMAN, AI = 0, 1
KEYS = {"f": FOLD, "c": CHECK_CALL, "r": RAISE_HALF, "p": RAISE_POT, "a": ALL_IN}
KEY_LABELS = {FOLD: "[f]old", CHECK_CALL: "[c]heck/call", RAISE_HALF: "[r]aise ½ pot",
